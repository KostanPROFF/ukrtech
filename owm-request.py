appid = "c7af5ef3db680089b95854a7f82df803"# полученный при регистрации на OpenWeatherMap.org. Что-то вроде такого набора букв и цифр: "6d8e495ca73d5bbc1d6bf8ebd52c4123"
...
if len(sys.argv) == 2:
    ...
    print('Enter name of city as one argument. For example: Kyiv.UA')
    sys.exit()
